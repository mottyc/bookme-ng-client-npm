(function (global, factory) {
    ...
    */
    var AdminMembersExportCsvRequest = /** @class */ (function () {
        function AdminMembersExportCsvRequest(format, search, role, status, sort) {
            this.format = format;
            this.search = search;
            this.role = role;
            this.status = status;
    ...
    */
    var AdminResourceExportCsvRequest = /** @class */ (function () {
        function AdminResourceExportCsvRequest(format, search, resourceClass, resourceType, status, forUseBy, sort) {
            this.format = format;
            this.search = search;
    ...
    */
    ...
    var AdminMembersService = /** @class */ (function () {
         ...
         * @return ActionResponse
         */
        AdminMembersService.prototype.importFile = function () {
         ...
         */
        AdminMembersService.prototype.exportFile = function (format, search, role, status, sort) {
            var _a;
            var params = new Array();
            if (format != null) {
    ...
    var AdminResourcesService = /** @class */ (function () {
         ...
         * @return ActionResponse
         */
        AdminResourcesService.prototype.importFile = function () {
            return this.rest.post(this.baseUrl + "/import", null);
        };
        /**
         ...
         * @return StreamContent
         */
        AdminResourcesService.prototype.exportFile = function (format, search, resourceClass, resourceType, status, forUseBy, sort) {
            var _a;
            var params = new Array();
            if (format != null) {
                params.push("format=" + format);
