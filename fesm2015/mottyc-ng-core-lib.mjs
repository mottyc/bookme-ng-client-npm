...
class RecurrentActivity {
    constructor(key, dayOfWeek, startTime, endTime, name, description, autoApprove, resourceFilter, roleFilter, limit, icon, iconColor) {
        this.key = key;
