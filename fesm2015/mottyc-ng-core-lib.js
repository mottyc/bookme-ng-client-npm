...
class AdminPlaningService {
     ...
     */
    getPlaning(id, resourceType) {
        const params = new Array();
        if (resourceType != null) {
            params.push(`resourceType=${resourceType}`);
        }
        return this.rest.get(`${this.baseUrl}/activity/${id}`, ...params);
    }
}
